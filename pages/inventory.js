          ...
          <div key={row.inventory_id} className="card">
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1">
                ...
                <div className="text-xs text-zinc-400">Value {row.item.price_gems} • {row.item.rarity}</div>
              </div>
            ...
            {!row.is_sold ? (
              ...
              <div className="mt-3 text-xs text-zinc-400">Sold for {row.sold_for_gems} gems</div>
            )}
          </div>
        ))}
      </div>
